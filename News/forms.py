...
class NewsForm(forms.ModelForm):
    ...
    def clean_title(self):
        ...
        if re.match(r'\d', title):
            raise ValueError('Заголовок не должно начинаться с цифр')
        return title
    ...
    # queryset=Category.objects.all(), label='Категория', empty_label='Выберите категорию', widget=forms.Select(attrs={
    # 'class':'form-control'}))
